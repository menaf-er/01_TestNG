...
public class C06_SoftAssert extends TestBase {
    ...
    public void test01() {
        ...
        softAssert.assertTrue(sonucYaziElementi.getText().contains("Kutella"), "sonuc yazısı KUTELLA içermiyor");

        // softassert'e bitis satirini soylemek icin assertAll() kullanilir
        // bu satir yazilmazsa assertion gorevi yapilmamis olur

        softAssert.assertAll(); // en sonunda yapılmıs olan tum hataları ve neleri yakaladıgnı buraya kadar getir bana
          /*
